...
[JAVA] 실습7 : 식당 대기번호 프로그램 (변수 활용)
	[ 목표 ]
Scanner, for(;;), if 문과 변수를 활용하여, 최대 3팀의 대기 명단을 관리할 수 있는 간단한 식당 대기번호 발행 프로그램을 구현합니다. 이 실습은 배열 없이 변수만으로 데이터를 관리하는 방법을 익히는 데 중점을 둡니다.
