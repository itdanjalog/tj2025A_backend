/*
[JAVA] 실습6 : 미니 게시판 만들기 (변수 활용)
[ 목표 ]
Scanner, for(;;), if 문과 변수를 활용하여, 최대 3개의 게시물을 저장하고 조회할 수 있는 간단한 콘솔 게시판 프로그램을 구현합니다. 이 실습은 배열을 사용하지 않고 변수만으로 데이터를 관리하는 방법을 익히는 데 중점을 둡니다.
